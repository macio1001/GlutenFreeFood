...
public class ShowRatingSzwajcaria extends Main5Activity {
    ...
    public void pokazOcene(String Nazwa, String Region, TextView WynikRating) {
        ...
        if (Region.equals("Bern") && Nazwa.equals("Ristorante-Pizzeria da Bucolo")) {
            firebaseFirestore.collection("Szwajcaria").whereEqualTo("Nazwa", "Ristorante-Pizzeria da Bucolo").addSnapshotListener(new EventListener<QuerySnapshot>() {
                @Override
