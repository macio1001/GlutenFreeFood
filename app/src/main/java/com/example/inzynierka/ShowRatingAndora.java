...
public class ShowRatingAndora extends Main5Activity{
    List<Object> ocena=new ArrayList<>();
    float suma,wynik,srednia;
    public void pokazOcene(String Nazwa,String Region,TextView WynikRating) {
        firebaseFirestore=FirebaseFirestore.getInstance();
        if(Nazwa.equals("Restaurant Moli dels Fanals") && Region.equals("La Massana")){
            firebaseFirestore.collection("Andora").addSnapshotListener(new EventListener<QuerySnapshot>() {
                @Override
