...
public class Szwajcaria extends Main5Activity {
    ...
    public void dodajOcene(float rating,String Region,String Nazwa){
        ...
        if(Region.equals("Bern") && Nazwa.equals("Ristorante-Pizzeria da Bucolo")){
            firebaseFirestore.collection("Szwajcaria").document("Ristorante-Pizzeria da Bucolo").collection("Ocena").add(ocena)
